...
// Added by Scott Lurowist 17 Sep 2020.
class DuplicateFlashcardError extends Error {
  constructor () {
    super();
    this.name = 'DuplicateFlashcardError';
    this.message = 'A duplicate flashcard was found; flashcards must be unique';
  }
}
...
const handleDuplicateFlashcardError = () => {
    throw new DuplicateFlashcardError();
}
